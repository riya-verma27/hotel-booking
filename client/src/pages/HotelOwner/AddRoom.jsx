...
const AddRoom = () => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      ...
      /*FormData() is a built-in JavaScript Web API used to construct a set of key/value pairs 
  ...
  return (
    <form onSubmit={onSubmitHandler}>
      ...
      room details, pricing and amenities, to enahance the use booking experience.'/>
      ...
      <div className='flex flex-col flex-wrap mt-1 text-gray-400 max-w-sm'>
        {Object.keys(inputs.amenities).map((amenity, index) => (
          <div key={index}>
            <input style = {{'cursor': 'pointer'}}type="checkbox" id={`amenities${index + 1}`} checked={inputs.amenities[amenity]}
