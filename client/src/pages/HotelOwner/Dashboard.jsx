...
const Dashboard = () => {
    const{getToken, axios, currency,user, toast}= useAppContext();
    ...
    return (
      ...
      and analyse revenue-all in one place. Stay updated with real-time insights to ensure smooth operations.'/>
