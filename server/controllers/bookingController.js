...
export const createBooking = async (req, res) => {
    try {
        ...
        const mailOptions = {
            ...
            <p>Dear ${req.user.username}, Thank You for your booking! Here are your booking details :</p>
            <ul>
...
export const getUserBookings = async (req, res) => {
    try {
        ...
        const bookings = await Booking.find({ user })
            .populate("room") // include room details
            .populate("hotel") // include hotel details
            .sort({ createdAt: -1 });
